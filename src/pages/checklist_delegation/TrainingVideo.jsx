...
const TrainingVideo = () => {
    ...
    const currentVideoUrl = isAdmin ? videoUrls.admin : videoUrls.user;
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2 bg-white rounded-lg px-4 py-2 shadow-sm">
                                ...
                                <span className="text-sm font-medium text-gray-700">
                                    {username} ({userRole.toLowerCase().includes("admin") ? "Admin" : "User"})
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-semibold text-gray-800">
                                    Help Video {userRole.toLowerCase().includes("admin") ? "(Admin Guide)" : "(User Guide)"}
                                </h2>
                            </div>
                                        ...
                                        <div className="h-80 flex items-center justify-center">
                                            <div className="text-center">
                                                ...
                                                <h3 className="text-lg font-semibold text-gray-700 mb-2">
                                                    {userRole.toLowerCase().includes("admin") ? "Admin" : "User"} Tutorial Video
                                                </h3>
