...
function ServiceDataPage() {
  ...
  const handleHistoryDelete = async () => {
    ...
    console.log(
      "🔴 BALAJI SERVICE: Current selectedHistoryItems:",
      Array.from(selectedHistoryItems)
    );
    console.log(
      "🔴 BALAJI SERVICE: Current historyData length:",
      historyData.length
    );

    const selectedHistoryItemsArray = Array.from(selectedHistoryItems);
    console.log(
      "🔴 BALAJI SERVICE: selectedHistoryItemsArray:",
      selectedHistoryItemsArray
    );
    ...
    console.log(
      "🔴 BALAJI SERVICE: Selected items count:",
      selectedHistoryItemsArray.length
    );
    ...
    try {
      console.log(
        "🔴 BALAJI SERVICE: Starting delete operation for items:",
        selectedHistoryItemsArray
      );
      ...
      console.log(
        "🔴 BALAJI SERVICE: BALAJI sheet doesn't support clearActualColumn action, using fallback strategies only"
      );
      console.log(
        `🔴 BALAJI SERVICE: Starting fallback strategies for ${selectedHistoryItemsArray.length} items...`
      );
      ...
      const rowDataNull = selectedHistoryItemsArray
        .map((id) => {
          ...
          console.log(
            `🔴 BALAJI SERVICE: Processing item ${id} with null value:`,
            {
              taskId: item["col1"],
              rowIndex: item._rowIndex,
            }
      ...
      if (rowDataNull.length > 0) {
        ...
        console.log(
          `🔴 BALAJI SERVICE: Strategy 1 - Making API call with null values...`
        );
        ...
        try {
          ...
          console.log(
            `🔴 BALAJI SERVICE: Strategy 1 - Response status: ${response1.status}`
          );

          if (response1.ok) {
            const responseText1 = await response1.text();
            console.log(
              `🔴 BALAJI SERVICE: Strategy 1 - Raw response: ${responseText1}`
            );
            ...
            try {
              ...
              console.log(
                `🔴 BALAJI SERVICE: Strategy 1 - Parsed response:`,
                result1
              );
            } catch (parseError) {
              console.log(
                `🔴 BALAJI SERVICE: Strategy 1 - Parse error, checking response:`,
                responseText1
              );
              ...
              if (responseText1.includes("Google Apps Script is running")) {
                console.warn(
                  `🔴 BALAJI SERVICE: Strategy 1 - BALAJI Apps Script is running but not responding properly`
                );
                result1 = {
                  success: false,
                  error: "Apps Script not responding",
            ...
            if (result1.success) {
              ...
              const hasUpdates = updateDetails.some(
                (detail) => detail.updates && detail.updates.length > 0
              );

              console.log(
                `🔴 BALAJI SERVICE: Strategy 1 - Has actual updates:`,
                hasUpdates
              );
              console.log(
                `🔴 BALAJI SERVICE: Strategy 1 - Update details:`,
                updateDetails
              );
              ...
              if (hasUpdates) {
                ...
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 1 - API succeeded but no updates made. Trying different parameters...`
                );
            ...
            console.log(
              `🔴 BALAJI SERVICE: Strategy 1 - HTTP error: ${response1.status}`
            );
          }
        } catch (error) {
      ...
      if (!clearSuccess) {
        console.log(
          `🔴 BALAJI SERVICE: Strategy 1.5 - Trying BALAJI-specific parameters...`
        );
        ...
        const rowDataBalaji = selectedHistoryItemsArray
          .map((id) => {
            ...
            console.log(
              `🔴 BALAJI SERVICE: Processing item ${id} with BALAJI parameters:`,
              {
                taskId: item["col1"],
                rowIndex: item._rowIndex,
              }
        ...
        console.log(
          `🔴 BALAJI SERVICE: Strategy 1.5 - rowDataBalaji:`,
          rowDataBalaji
        );
        ...
        if (rowDataBalaji.length > 0) {
          ...
          console.log(
            `🔴 BALAJI SERVICE: Strategy 1.5 - Making API call with BALAJI-specific parameters...`
          );
          ...
          try {
            ...
            console.log(
              `🔴 BALAJI SERVICE: Strategy 1.5 - Response status: ${response15.status}`
            );

            if (response15.ok) {
              const responseText15 = await response15.text();
              console.log(
                `🔴 BALAJI SERVICE: Strategy 1.5 - Raw response: ${responseText15}`
              );
              ...
              try {
                ...
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 1.5 - Parsed response:`,
                  result15
                );
              } catch (parseError) {
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 1.5 - Parse error, checking for success text`
                );
              ...
              if (result15.success) {
                ...
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 1.5 - Has actual updates:`,
                  hasUpdates
                );
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 1.5 - Update details:`,
                  updateDetails
                );
                ...
                if (hasUpdates) {
                  ...
                  console.log(
                    `🔴 BALAJI SERVICE: Strategy 1.5 - API succeeded but no updates made. Continuing to Strategy 2...`
                  );
                }
              } else {
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 1.5 - Failed:`,
                  result15
                );
              }
            } else {
              console.log(
                `🔴 BALAJI SERVICE: Strategy 1.5 - HTTP error: ${response15.status}`
              );
            }
          } catch (error) {
            console.error(
              `🔴 BALAJI SERVICE: Strategy 1.5 - Exception:`,
              error
            );
            // Ignore and try next
          }
      ...
      if (!clearSuccess) {
        ...
        console.log(
          `🔴 BALAJI SERVICE: Strategy 2 - rowDataSentinel:`,
          rowDataSentinel
        );
        ...
        if (rowDataSentinel.length > 0) {
          ...
          console.log(
            `🔴 BALAJI SERVICE: Strategy 2 - Making API call with empty string values...`
          );
          ...
          try {
            ...
            console.log(
              `🔴 BALAJI SERVICE: Strategy 2 - Response status: ${response2.status}`
            );

            if (response2.ok) {
              const responseText2 = await response2.text();
              console.log(
                `🔴 BALAJI SERVICE: Strategy 2 - Raw response: ${responseText2}`
              );
              ...
              try {
                ...
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 2 - Parsed response:`,
                  result2
                );
              } catch (parseError) {
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 2 - Parse error, checking response:`,
                  responseText2
                );
                ...
                if (responseText2.includes("Google Apps Script is running")) {
                  console.warn(
                    `🔴 BALAJI SERVICE: Strategy 2 - BALAJI Apps Script is running but not responding properly`
                  );
                  result2 = {
                    success: false,
                    error: "Apps Script not responding",
              ...
              if (result2.success) {
                ...
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 2 - Has actual updates:`,
                  hasUpdates
                );
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 2 - Update details:`,
                  updateDetails
                );
                ...
                if (hasUpdates) {
                  ...
                  console.log(
                    `🔴 BALAJI SERVICE: Strategy 2 - API succeeded but no updates made. Trying Strategy 3...`
                  );
                }
              } else {
              ...
              console.log(
                `🔴 BALAJI SERVICE: Strategy 2 - HTTP error: ${response2.status}`
              );
            }
          } catch (error) {
      ...
      if (!clearSuccess) {
        ...
        console.log(
          `🔴 BALAJI SERVICE: Strategy 3 - rowDataForce:`,
          rowDataForce
        );
        ...
        if (rowDataForce.length > 0) {
          ...
          console.log(
            `🔴 BALAJI SERVICE: Strategy 3 - Making API call with force clear flags...`
          );
          ...
          try {
            ...
            console.log(
              `🔴 BALAJI SERVICE: Strategy 3 - Response status: ${response3.status}`
            );

            if (response3.ok) {
              const responseText3 = await response3.text();
              console.log(
                `🔴 BALAJI SERVICE: Strategy 3 - Raw response: ${responseText3}`
              );
              ...
              try {
                ...
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 3 - Parsed response:`,
                  result3
                );
              } catch (parseError) {
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 3 - Parse error, checking response:`,
                  responseText3
                );
                ...
                if (responseText3.includes("Google Apps Script is running")) {
                  console.warn(
                    `🔴 BALAJI SERVICE: Strategy 3 - BALAJI Apps Script is running but not responding properly`
                  );
                  result3 = {
                    success: false,
                    error: "Apps Script not responding",
                    message: responseText3,
                  };
              ...
              if (result3.success) {
                ...
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 3 - Has actual updates:`,
                  hasUpdates
                );
                console.log(
                  `🔴 BALAJI SERVICE: Strategy 3 - Update details:`,
                  updateDetails
                );
                ...
                if (hasUpdates) {
                  ...
                  console.log(
                    `🔴 BALAJI SERVICE: Strategy 3 - API succeeded but no updates made.`
                  );
                }
              } else {
              ...
              console.log(
                `🔴 BALAJI SERVICE: Strategy 3 - HTTP error: ${response3.status}`
              );
            }
          } catch (error) {
      ...
      if (!clearSuccess) {
        console.error(
          `🔴 BALAJI SERVICE: All clear strategies failed for items:`,
          selectedHistoryItemsArray
        );
        throw new Error(
      ...
      console.log(
        `🔴 BALAJI SERVICE: Waiting 2 seconds before refreshing data...`
      );
      ...
      console.log(
        `🔴 BALAJI SERVICE: Delete operation COMPLETED successfully!`
      );
    } catch (error) {
