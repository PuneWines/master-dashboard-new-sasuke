  ...
  const fetchSheetData = useCallback(async () => {
    try {
      ...
      rows.forEach((row, rowIndex) => {
        ...
        if (
          columnMValue &&
          columnMValue.toString().trim().toUpperCase() === "DONE"
        ) {
          return;
        }
        ...
        // FIXED: Show tasks from past dates up to today (including today), but exclude tomorrow
        ...
        //     console.log(
        //       `Date check - Row: ${formattedRowDate}, Today: ${formatDateToDDMMYYYY(
        //         normalizedToday
